...
public class StackApp {
    public static void main(String[] args) {
        ...
        // + F : '14.6.7.1. L'interface java.util.Deque' (ca aide si vous y retrouvez
        // sinon utilisé les autres)
        ...
        Stack<String> myStackOfCars = new Stack<>();
        ...
        String poppedValue = myStackOfCars.pop();
        System.out.println("Dernière marque ajoutée : " + poppedValue);
        ...
        // Recherche et affichage de la position d'un des éléments (la valeur indiquera
        ...
        if (position != -1) {
            System.out.println("La position de l'élément " + elementToSearch
                    + " par rapport au sommet de la pile est : " + position);
        } else {
